...
export default function FloatingWhatsAppOrder({ phone, message }: { phone: string; message: string }) {
  ...
  return (
    <a href={href} target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:opacity-90 text-white p-4 rounded-full shadow-lg flex items-center gap-2">
